...
class Interop {
  ...
  public: class Kernel32 {
    ...
    public: static Boolean EnumSystemLocalesEx(IntPtr lpLocaleEnumProcEx, UInt32 dwFlags, void* lParam, IntPtr reserved);
    public: static Boolean EnumTimeFormatsEx(IntPtr lpTimeFmtEnumProcEx, String lpLocaleName, UInt32 dwFlags, void* lParam);
    ...
    public: static Boolean EnumCalendarInfoExEx(IntPtr pCalInfoEnumProcExEx, String lpLocaleName, UInt32 Calendar, String lpReserved, UInt32 CalType, void* lParam);
  ...
  public: class Globalization {
    ...
    public: static Boolean EnumCalendarInfo(IntPtr callback, String localeName, CalendarId calendarId, CalendarDataType calendarDataType, IntPtr context);
