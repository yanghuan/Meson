...
CLASS(TimeZoneInfo) : public object {
  ...
  public: CLASS(AdjustmentRule) : public object {
    ...
    public: Int32 GetHashCode();
    public: void ctor(DateTime dateStart, DateTime dateEnd, TimeSpan daylightDelta, TransitionTime daylightTransitionStart, TransitionTime daylightTransitionEnd, TimeSpan baseUtcOffsetDelta, Boolean noDaylightTransitions);
  ...
  public: void ctor(String id, TimeSpan baseUtcOffset, String displayName, String standardDisplayName, String daylightDisplayName, Array<AdjustmentRule> adjustmentRules, Boolean disableDaylightSavingTime);
  ...
  public: void ctor(Interop::Kernel32::TIME_ZONE_INFORMATION& zone, Boolean dstDisabled);
