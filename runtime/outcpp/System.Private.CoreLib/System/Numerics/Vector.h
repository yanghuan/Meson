...
struct Vector<T> : public valueType<Vector<T>> {
  ...
  public: static Vector<UInt16> op_Explicit(Vector<T> value);
  public: static Vector<Int16> op_Explicit(Vector<T> value);
  public: static Vector<UInt32> op_Explicit(Vector<T> value);
  public: static Vector<Int32> op_Explicit(Vector<T> value);
  public: static Vector<UInt64> op_Explicit(Vector<T> value);
  public: static Vector<Int64> op_Explicit(Vector<T> value);
  public: static Vector<Single> op_Explicit(Vector<T> value);
