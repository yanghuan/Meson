...
CLASS(SignatureHelper) : public object {
  ...
  public: void ctor(Module mod, MdSigCallingConvention callingConvention);
  public: void ctor(Module mod, MdSigCallingConvention callingConvention, Int32 cGenericParameters, Type returnType, Array<Type> requiredCustomModifiers, Array<Type> optionalCustomModifiers);
  public: void ctor(Module mod, MdSigCallingConvention callingConvention, Type returnType, Array<Type> requiredCustomModifiers, Array<Type> optionalCustomModifiers);
  public: void ctor(Module mod, Type type);
