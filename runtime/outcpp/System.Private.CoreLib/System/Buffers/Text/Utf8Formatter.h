...
class Utf8Formatter {
  ...
  public: static Boolean TryFormat(Boolean value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(DateTimeOffset value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(DateTime value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  ...
  public: static Boolean TryFormat(Decimal value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  ...
  public: static Boolean TryFormat(Double value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(Single value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  private: template <class T>
  static Boolean TryFormatFloatingPoint(T value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format);
  public: static Boolean TryFormat(Guid value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(Byte value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(SByte value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(UInt16 value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(Int16 value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(UInt32 value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(Int32 value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(UInt64 value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  public: static Boolean TryFormat(Int64 value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
  ...
  public: static Boolean TryFormat(TimeSpan value, Span<Byte> destination, Int32& bytesWritten, StandardFormat format = rt::default);
