...
class Utf8Formatter {
  ...
  private: static Boolean TryFormatInt32MultipleDigits(Int32 value, Span<Byte> destination, Int32& bytesWritten);
  private: static Boolean TryFormatInt64MultipleDigits(Int64 value, Span<Byte> destination, Int32& bytesWritten);
  private: static Boolean TryFormatInt64MoreThanNegativeBillionMaxUInt(Int64 value, Span<Byte> destination, Int32& bytesWritten);
  private: static Boolean TryFormatInt64LessThanNegativeBillionMaxUInt(Int64 value, Span<Byte> destination, Int32& bytesWritten);
  ...
  private: static Boolean TryFormatUInt32MultipleDigits(UInt32 value, Span<Byte> destination, Int32& bytesWritten);
  private: static Boolean TryFormatUInt64MultipleDigits(UInt64 value, Span<Byte> destination, Int32& bytesWritten);
  private: static Boolean TryFormatUInt64LessThanBillionMaxUInt(UInt64 value, Span<Byte> destination, Int32& bytesWritten);
  private: static Boolean TryFormatUInt64MoreThanBillionMaxUInt(UInt64 value, Span<Byte> destination, Int32& bytesWritten);
