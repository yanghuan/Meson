...
class Buffer {
  ...
  public: static void _ZeroMemory(Byte& b, UInt64 byteLength);
  private: static void __ZeroMemory(void* b, UInt64 byteLength);
  public: static void BulkMoveWithWriteBarrier(Byte& destination, Byte& source, UInt64 byteCount);
  private: static void _BulkMoveWithWriteBarrier(Byte& destination, Byte& source, UInt64 byteCount);
  private: static void __BulkMoveWithWriteBarrier(Byte& destination, Byte& source, UInt64 byteCount);
