    ...
    try {
      ...
      if (num != 3) {
        if (cancellationToken.get_CanBeCanceled()) {
          ...
          <cancellationReg>5__6 = cancellationToken.UnsafeRegister(as != nullptr ? as : (__c::in::__9__128_0 = {__c::in::__9, &__c::in::_AsyncModeCopyToAsync_b__128_0}), <readAwaitable>5__2);
        }
        goto IL_0219;
      }
