...
class SpanHelpers {
  ...
  public: static Int32 IndexOfAny(Char& searchStart, Char value0, Char value1, Int32 length);
  public: static Int32 IndexOfAny(Char& searchStart, Char value0, Char value1, Char value2, Int32 length);
  public: static Int32 IndexOfAny(Char& searchStart, Char value0, Char value1, Char value2, Char value3, Int32 length);
  public: static Int32 IndexOfAny(Char& searchStart, Char value0, Char value1, Char value2, Char value3, Char value4, Int32 length);
  ...
  private: static Vector<UInt16> LoadVector(Char& start, UIntPtr offset);
  private: static Vector128<UInt16> LoadVector128(Char& start, IntPtr offset);
  private: static Vector128<UInt16> LoadVector128(Char& start, UIntPtr offset);
  private: static Vector256<UInt16> LoadVector256(Char& start, IntPtr offset);
  private: static Vector256<UInt16> LoadVector256(Char& start, UIntPtr offset);
  private: static Char& Add(Char& start, UIntPtr offset);
