...
struct ValueTuple<> : public valueType<ValueTuple<>> {
  ...
  static ValueTuple<> Create(T1 item1, T2 item2);
  public: template <class T1, class T2, class T3>
  static ValueTuple<> Create(T1 item1, T2 item2, T3 item3);
  public: template <class T1, class T2, class T3, class T4>
  static ValueTuple<> Create(T1 item1, T2 item2, T3 item3, T4 item4);
  public: template <class T1, class T2, class T3, class T4, class T5>
  static ValueTuple<> Create(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5);
  public: template <class T1, class T2, class T3, class T4, class T5, class T6>
  static ValueTuple<> Create(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6);
  public: template <class T1, class T2, class T3, class T4, class T5, class T6, class T7>
  static ValueTuple<> Create(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7);
  public: template <class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8>
  static ValueTuple<> Create(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, T8 item8);
};
template <class T1>
