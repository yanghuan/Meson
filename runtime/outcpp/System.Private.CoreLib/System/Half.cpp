...
Half Half::Parse(String s) {
  ...
  return Number::ParseHalf(s, NumberStyles::Float | NumberStyles::AllowThousands, NumberFormatInfo::in::get_CurrentInfo());
}
...
Half Half::Parse(String s, IFormatProvider provider) {
  ...
  return Number::ParseHalf(s, NumberStyles::Float | NumberStyles::AllowThousands, NumberFormatInfo::in::GetInstance(provider));
}
...
Boolean Half::TryParse(String s, Half& result) {
  ...
  return TryParse(s, NumberStyles::Float | NumberStyles::AllowThousands, nullptr, result);
}
...
UInt32 Half::StripSign(Half value) {
  return (UInt16)(value._value & 4294934527u);
}
...
Half Half::op_Explicit(Single value) {
  ...
  Boolean flag = (num & 2147483648u) >> 31 != 0;
  Int32 num2 = (Int32)(num & 2139095040) >> 23;
  UInt32 num3 = num & 8388607u;
  if (num2 == 255) {
    if (num3 != 0) {
  ...
  UInt32 num4 = (num3 >> 9) | (((num3 & 511u) != 0) ? 1u : 0u);
  if (((UInt32)num2 | num4) == 0) {
    return Half(flag, 0, 0);
  }
  return Half(RoundPackToHalf(flag, (Int16)(num2 - 113), (UInt16)(num4 | 16384u)));
}

Half Half::op_Explicit(Double value) {
  UInt64 num = (UInt64)BitConverter::DoubleToInt64Bits(value);
  Boolean flag = (num & 9223372036854775808) >> 63 != 0;
  ...
  return Half(RoundPackToHalf(flag, (Int16)(num2 - 1009), (UInt16)(num4 | 16384u)));
}
...
Half Half::Negate(Half value) {
  if (!IsNaN(value)) {
    return Half((UInt16)(value._value ^ 32768u));
  }
  return value;
}
