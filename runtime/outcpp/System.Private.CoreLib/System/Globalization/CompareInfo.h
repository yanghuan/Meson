...
CLASS(CompareInfo) : public Object::in {
  ...
  public: Int32 Compare(ReadOnlySpan<Char> string1, ReadOnlySpan<Char> string2, CompareOptions options);
  ...
  public: Int32 IndexOf(ReadOnlySpan<Char> source, Rune value, CompareOptions options);
  ...
  public: Int32 LastIndexOf(ReadOnlySpan<Char> source, Rune value, CompareOptions options);
  public: SortKey GetSortKey(String source, CompareOptions options);
  public: SortKey GetSortKey(String source);
  private: SortKey CreateSortKeyCore(String source, CompareOptions options);
  public: Int32 GetSortKey(ReadOnlySpan<Char> source, Span<Byte> destination, CompareOptions options);
  private: Int32 GetSortKeyCore(ReadOnlySpan<Char> source, Span<Byte> destination, CompareOptions options);
  public: Int32 GetSortKeyLength(ReadOnlySpan<Char> source, CompareOptions options);
