...
CLASS(CompareInfo) : public object {
  ...
  public: Boolean IsPrefix(ReadOnlySpan<Char> source, ReadOnlySpan<Char> prefix, CompareOptions options, Int32& matchLength);
  private: Boolean StartsWithCore(ReadOnlySpan<Char> source, ReadOnlySpan<Char> prefix, CompareOptions options, Int32* matchLengthPtr);
  ...
  public: Boolean IsSuffix(ReadOnlySpan<Char> source, ReadOnlySpan<Char> suffix, CompareOptions options, Int32& matchLength);
  public: Boolean IsSuffix(String source, String suffix);
  private: Boolean EndsWithCore(ReadOnlySpan<Char> source, ReadOnlySpan<Char> suffix, CompareOptions options, Int32* matchLengthPtr);
  ...
  public: Int32 IndexOf(ReadOnlySpan<Char> source, ReadOnlySpan<Char> value, CompareOptions options, Int32& matchLength);
  public: Int32 IndexOf(ReadOnlySpan<Char> source, Rune value, CompareOptions options = CompareOptions::None);
  private: Int32 IndexOf(ReadOnlySpan<Char> source, ReadOnlySpan<Char> value, Int32* matchLengthPtr, CompareOptions options, Boolean fromBeginning);
  ...
  public: Int32 LastIndexOf(ReadOnlySpan<Char> source, ReadOnlySpan<Char> value, CompareOptions options, Int32& matchLength);
  ...
  private: Boolean IcuStartsWith(ReadOnlySpan<Char> source, ReadOnlySpan<Char> prefix, CompareOptions options, Int32* matchLengthPtr);
  private: Boolean StartsWithOrdinalIgnoreCaseHelper(ReadOnlySpan<Char> source, ReadOnlySpan<Char> prefix, CompareOptions options, Int32* matchLengthPtr);
  private: Boolean StartsWithOrdinalHelper(ReadOnlySpan<Char> source, ReadOnlySpan<Char> prefix, CompareOptions options, Int32* matchLengthPtr);
  private: Boolean IcuEndsWith(ReadOnlySpan<Char> source, ReadOnlySpan<Char> suffix, CompareOptions options, Int32* matchLengthPtr);
  private: Boolean EndsWithOrdinalIgnoreCaseHelper(ReadOnlySpan<Char> source, ReadOnlySpan<Char> suffix, CompareOptions options, Int32* matchLengthPtr);
  private: Boolean EndsWithOrdinalHelper(ReadOnlySpan<Char> source, ReadOnlySpan<Char> suffix, CompareOptions options, Int32* matchLengthPtr);
  ...
  public: static Int32 NlsIndexOfOrdinalCore(ReadOnlySpan<Char> source, ReadOnlySpan<Char> value, Boolean ignoreCase, Boolean fromBeginning);
  private: Int32 NlsGetHashCodeOfString(ReadOnlySpan<Char> source, CompareOptions options);
  public: static Int32 NlsCompareStringOrdinalIgnoreCase(Char& string1, Int32 count1, Char& string2, Int32 count2);
  ...
  private: Boolean NlsStartsWith(ReadOnlySpan<Char> source, ReadOnlySpan<Char> prefix, CompareOptions options, Int32* matchLengthPtr);
  private: Boolean NlsEndsWith(ReadOnlySpan<Char> source, ReadOnlySpan<Char> suffix, CompareOptions options, Int32* matchLengthPtr);
