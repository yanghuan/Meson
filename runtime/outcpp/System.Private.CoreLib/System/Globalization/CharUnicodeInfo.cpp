...
UInt64 CharUnicodeInfo::GetCategoryCasingTableOffsetNoBoundsChecks(UInt32 codePoint) {
  return UInt64();
};
UInt64 CharUnicodeInfo::GetNumericGraphemeTableOffsetNoBoundsChecks(UInt32 codePoint) {
  return UInt64();
};
} // namespace System::Private::CoreLib::System::Globalization::CharUnicodeInfoNamespace
