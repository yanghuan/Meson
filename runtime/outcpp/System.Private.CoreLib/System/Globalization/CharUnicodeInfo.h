...
class CharUnicodeInfo {
  ...
  private: static UInt64 GetCategoryCasingTableOffsetNoBoundsChecks(UInt32 codePoint);
  private: static UInt64 GetNumericGraphemeTableOffsetNoBoundsChecks(UInt32 codePoint);
};
} // namespace CharUnicodeInfoNamespace
