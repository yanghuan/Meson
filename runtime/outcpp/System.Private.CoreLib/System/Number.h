...
class Number {
  ...
  public: struct BigInteger {
    public: static void Add(BigInteger& lhs, UInt32 value, BigInteger& result);
    ...
    public: static void ShiftLeft(UInt64 input, UInt32 shift, BigInteger& output);
    ...
    public: void ExtendBlock(UInt32 blockValue);
    public: void ExtendBlocks(UInt32 blockValue, UInt32 blockCount);
    ...
    public: void SetValue(BigInteger& rhs);
    public: void SetZero();
  ...
  public: static String FormatInt32(Int32 value, ReadOnlySpan<Char> format, IFormatProvider provider);
  public: static Boolean TryFormatInt32(Int32 value, ReadOnlySpan<Char> format, IFormatProvider provider, Span<Char> destination, Int32& charsWritten);
  public: static String FormatUInt32(UInt32 value, ReadOnlySpan<Char> format, IFormatProvider provider);
  ...
  public: static String FormatInt64(Int64 value, ReadOnlySpan<Char> format, IFormatProvider provider);
  ...
  public: static String FormatUInt64(UInt64 value, ReadOnlySpan<Char> format, IFormatProvider provider);
  ...
  private: static String UInt64ToDecStr(UInt64 value, Int32 digits);
  ...
  private: static void FormatFixed(ValueStringBuilder& sb, NumberBuffer& number, Int32 nMaxDigits, NumberFormatInfo info, Array<Int32> groupDigits, String sDecimal, String sGroup);
  ...
  public: static void ThrowOverflowOrFormatException(ParsingStatus status, TypeCode type);
