...
CLASS(EventProvider) {
  ...
  private: void EtwEnableCallBack(Guid& sourceId, Int32 controlCode, Byte setLevel, Int64 anyKeyword, Int64 allKeyword, Interop::Advapi32::in::EVENT_FILTER_DESCRIPTOR* filterData, void* callbackContext);
  ...
  private: Boolean GetDataFromController(Int32 etwSessionId, Interop::Advapi32::in::EVENT_FILTER_DESCRIPTOR* filterData, ControllerCommand& command, Array<Byte>& data, Int32& dataStart);
  ...
  private: UInt32 EventRegister(EventSource eventSource, Interop::Advapi32::in::EtwEnableCallback enableCallback);
  private: UInt32 EventUnregister(Int64 registrationHandle);
  public: Int32 SetInformation(Interop::Advapi32::in::EVENT_INFO_CLASS eventInfoClass, IntPtr data, UInt32 dataSize);
  public: IEventProvider m_eventProvider;
  private: Interop::Advapi32::in::EtwEnableCallback m_etwCallback;
