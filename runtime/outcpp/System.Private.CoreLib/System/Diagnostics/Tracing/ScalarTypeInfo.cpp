...
TraceLoggingTypeInfo ScalarTypeInfo___::Boolean() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Boolean>(), Statics::Format8, TraceLoggingDataType::Boolean8);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Byte() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Byte>(), Statics::Format8, TraceLoggingDataType::UInt8);
}

TraceLoggingTypeInfo ScalarTypeInfo___::SByte() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<SByte>(), Statics::Format8, TraceLoggingDataType::Int8);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Char() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Char>(), Statics::Format16, TraceLoggingDataType::Char16);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Int16() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Int16>(), Statics::Format16, TraceLoggingDataType::Int16);
}

TraceLoggingTypeInfo ScalarTypeInfo___::UInt16() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<UInt16>(), Statics::Format16, TraceLoggingDataType::UInt16);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Int32() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Int32>(), Statics::Format32, TraceLoggingDataType::Int32);
}

TraceLoggingTypeInfo ScalarTypeInfo___::UInt32() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<UInt32>(), Statics::Format32, TraceLoggingDataType::UInt32);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Int64() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Int64>(), Statics::Format64, TraceLoggingDataType::Int64);
}

TraceLoggingTypeInfo ScalarTypeInfo___::UInt64() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<UInt64>(), Statics::Format64, TraceLoggingDataType::UInt64);
}

TraceLoggingTypeInfo ScalarTypeInfo___::IntPtr() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<IntPtr>(), Statics::FormatPtr, Statics::IntPtrType);
}

TraceLoggingTypeInfo ScalarTypeInfo___::UIntPtr() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<UIntPtr>(), Statics::FormatPtr, Statics::UIntPtrType);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Single() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Single>(), Statics::Format32, TraceLoggingDataType::Float);
}

TraceLoggingTypeInfo ScalarTypeInfo___::Double() {
  return rt::newobj<ScalarTypeInfo>(rt::typeof<Double>(), Statics::Format64, TraceLoggingDataType::Double);
}
