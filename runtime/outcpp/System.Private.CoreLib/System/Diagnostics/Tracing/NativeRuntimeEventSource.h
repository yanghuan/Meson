...
CLASS(NativeRuntimeEventSource) {
  public: CLASS(Keywords) {
    public: static constexpr EventKeywords GCKeyword = 1;
    public: static constexpr EventKeywords GCHandleKeyword = 2;
    public: static constexpr EventKeywords AssemblyLoaderKeyword = 4;
    public: static constexpr EventKeywords LoaderKeyword = 8;
    public: static constexpr EventKeywords JitKeyword = 16;
    public: static constexpr EventKeywords NGenKeyword = 32;
    public: static constexpr EventKeywords StartEnumerationKeyword = 64;
    public: static constexpr EventKeywords EndEnumerationKeyword = 128;
    public: static constexpr EventKeywords SecurityKeyword = 1024;
    public: static constexpr EventKeywords AppDomainResourceManagementKeyword = 2048;
    public: static constexpr EventKeywords JitTracingKeyword = 4096;
    public: static constexpr EventKeywords InteropKeyword = 8192;
    public: static constexpr EventKeywords ContentionKeyword = 16384;
    public: static constexpr EventKeywords ExceptionKeyword = 32768;
    public: static constexpr EventKeywords ThreadingKeyword = 65536;
    public: static constexpr EventKeywords JittedMethodILToNativeMapKeyword = 131072;
    public: static constexpr EventKeywords OverrideAndSuppressNGenEventsKeyword = 262144;
    public: static constexpr EventKeywords TypeKeyword = 524288;
    public: static constexpr EventKeywords GCHeapDumpKeyword = 1048576;
    public: static constexpr EventKeywords GCSampledObjectAllocationHighKeyword = 2097152;
    public: static constexpr EventKeywords GCHeapSurvivalAndMovementKeyword = 4194304;
    public: static constexpr EventKeywords GCHeapCollectKeyword = 8388608;
    public: static constexpr EventKeywords GCHeapAndTypeNamesKeyword = 16777216;
    public: static constexpr EventKeywords GCSampledObjectAllocationLowKeyword = 33554432;
    public: static constexpr EventKeywords PerfTrackKeyword = 536870912;
    public: static constexpr EventKeywords StackKeyword = 1073741824;
    public: static constexpr EventKeywords ThreadTransferKeyword = 2147483648;
    public: static constexpr EventKeywords DebuggerKeyword = 4294967296;
    public: static constexpr EventKeywords MonitoringKeyword = 8589934592;
    public: static constexpr EventKeywords CodeSymbolsKeyword = 17179869184;
    public: static constexpr EventKeywords EventSourceKeyword = 34359738368;
    public: static constexpr EventKeywords CompilationKeyword = 68719476736;
    public: static constexpr EventKeywords CompilationDiagnosticKeyword = 137438953472;
    public: static constexpr EventKeywords MethodDiagnosticKeyword = 274877906944;
  };
  ...
  public: static constexpr String EventSourceName = "Microsoft-Windows-DotNETRuntime";
